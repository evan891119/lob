...
ALTER TABLE lob.capture_sessions ADD COLUMN IF NOT EXISTS queue_high_water UInt32 AFTER reconnects;
ALTER TABLE lob.capture_sessions ADD COLUMN IF NOT EXISTS batch_count UInt64 AFTER queue_high_water;
